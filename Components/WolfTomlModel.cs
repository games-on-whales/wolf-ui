...
class WolfGstreamerVideoDefaults
{
...
class WolfGstreamerVideoEncoder
{
...
class WolfGstreamerVideoDefaultsEntry
{
    public string Video_params {get;set;}
}
